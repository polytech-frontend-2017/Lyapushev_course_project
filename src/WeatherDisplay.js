...
class WeatherDisplay extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div role="contentinfo" className="head">
          <h1 className="head">
            {weather.main} in {weatherData.name} ({weatherData.sys.country})
          </h1>
        </div>

        <div role="menuitem" className="todayWeather" id="todayWeather">
          <div role="img" className="image" id="image">
            <img
              src={iconUrl}
              width="150"
              height="160"
          ...
          <div role="main" className="todayTemp" id="todayTemp">
